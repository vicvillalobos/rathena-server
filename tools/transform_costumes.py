...
class ItemRenewal:
    def __init__(self, id, name_aegis, name_english, type, subtype, price_buy, price_sell, weight, location_costume_head_top, location_costume_head_mid, location_costume_head_low, location_costume_garment, view, equip_script, unequip_script):
        self.id = id
    ...
    def generate_prerenewal_insert(self):
        ...
        return (
            "INSERT INTO item_db2 (id, name_aegis, name_english, type, subtype, price_buy, price_sell, weight, location_costume_head_top, location_costume_head_mid, location_costume_head_low, location_costume_garment, view, armor_level, equip_script, unequip_script) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 1);",
            (self.id, self.name_aegis, self.name_english, self.type, self.subtype, self.price_buy, self.price_sell, self.weight, self.location_costume_head_top, self.location_costume_head_mid, self.location_costume_head_low, self.location_costume_garment, self.view, self.equip_script, self.unequip_script)
        )
        
    def generate_prerenewal_update(self):
        # Generate the update statement for the pre-renewal database
        return (
            "UPDATE item_db2 SET name_aegis = %s, name_english = %s, type = %s, subtype = %s, price_buy = %s, price_sell = %s, weight = %s, location_costume_head_top = %s, location_costume_head_mid = %s, location_costume_head_low = %s, location_costume_garment = %s, view = %s, equip_script = %s, unequip_script = %s WHERE id = %s;",
            (self.name_aegis, self.name_english, self.type, self.subtype, self.price_buy, self.price_sell, self.weight, self.location_costume_head_top, self.location_costume_head_mid, self.location_costume_head_low, self.location_costume_garment, self.view, self.equip_script, self.unequip_script, self.id)
        )
